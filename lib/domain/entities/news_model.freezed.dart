...
class _$NewsModelImpl implements _NewsModel {
  ...
  @override
  String toString() {
    return 'NewsModel(id: $id, date: $date, dateTime: $dateTime, description: $description, title: $title, imageUrl: $imageUrl)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, id, date, dateTime, description, title, imageUrl);
